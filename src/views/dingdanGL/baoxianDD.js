...
export default class baoxianDD extends Component {
        ...
        return (
            <div className="daikuanDD">
                ...
                <div>&nbsp;
                    ...
                    转单类型:&nbsp; <Select defaultValue="信用贷" style={{ width: 120 }} onChange={handleChange}>
                    ...
                    客服名称:&nbsp;<Select defaultValue="lucy" style={{ width: 120 }} onChange={handleChange}>
                                <Option value="jack">{this.state.datajson.customerName}</Option>
